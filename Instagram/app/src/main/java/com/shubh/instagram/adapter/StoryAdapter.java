package com.shubh.instagram.adapter;
...
import com.shubh.instagram.AddStoryActivity;
import com.shubh.instagram.R;
import com.shubh.instagram.model.Story;
import com.shubh.instagram.model.User;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder> {
    ...
    private void myStory(final TextView textView, final ImageView imageView, final boolean click) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                int count = 0;
                long timecurrnt = System.currentTimeMillis();
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    Story story = snapshot.getValue(Story.class);
                    if (timecurrnt > story.getTimestart() && timecurrnt < story.getTimeend()) {
                        count++;
                    }
                }
                if (click) {
